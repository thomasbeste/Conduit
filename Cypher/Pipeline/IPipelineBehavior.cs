...
/// </code>
///
/// <para>Register behaviors using <see cref="CypherConfiguration.AddBehavior{TBehavior}"/> for closed types
/// or <see cref="CypherConfiguration.AddOpenBehavior"/> for open generic behaviors.</para>
/// </remarks>
